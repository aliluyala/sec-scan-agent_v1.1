...
PASSWORD_DIC = ['123456','admin','root','password','123123','123','1','{user}','{user}{user}','{user}1','{user}123','{user}@123','{user}2016','{user}2015','{user}2014','{user}!','{user}1234','','P@ssw0rd!!','qwa123','12345678','test','123qwe!@#','123456789','123321','1314520','666666','woaini','fuckyou','000000','1234567890','8888888','qwerty','1qaz2wsx','abc123','abc123456','1q2w3e4r','123qwe','159357','p@ssw0rd','p@55w0rd','password!','p@ssw0rd!','password1','r00t','tomcat','apache','system','Q12_test']
REGEX = [['ftp', '21', '^220.*?ftp|^220-|^220 Service|^220 FileZilla'],  ['telnet', '23', '^\\xff[\\xfa-\\xfe]|^\\x54\\x65\\x6c|Telnet'],['web', '80', ''],['mssql', '1433', ''],['mysql', '3306', '^.\\0\\0\\0.*?mysql|^.\\0\\0\\0\\n|.*?MariaDB server'],['postgresql', '5432', ''], ['redis', '6379', '-ERR|^\\$\\d+\\r\\nredis_version'], ['elasticsearch', '9200', ''], ['memcached', '11211', '^ERROR'], ['mongodb', '27017', ''], ['snmp', '161', ''], ['LDAP', '389', ''], ['rsync', '873', ''], ['rmi', '1099', ''], ['oracle', '1521', ''], ['bes', '1900', ''], ['zookeeper', '2181', ''], ['resin-jndi', '10068', ''], ['docker', '2375', ''], ['hadoop', '50070', ''], ['SAP', '5000', ''], ['dubbo', '20880', ''], ['WebSphere', '9090', ''], ['fcgi', '9000', ''], ['solr', '8983', ''], ['tomcat', '8080', ''], ['jboss', '8089', ''], ['haikang', '8000', ''], ['Weblogic', '7001', ''],['varnish', '6082', ''],['CouchDB', '5984', ''],['GlassFish', '4848', ''],['svn', '3690', ''],['kangle', '3311', ''],['Webrick', '3000', '']]
class Crack():
...
python Scrack.py -h 10.111.1.1-10.111.2.254 -p 3306,5432 -m 20 -t 6
python Scrack.py -h ip.ini -n -m 20 -t 6
    '''
    if len(sys.argv) < 2:
        print msg
    try:
        ...
        ip = ''
        port = '21,23,80,1433,3306,5432,6379,9200,11211,27017,161,389,873,1099,1521,1900,2181,10068,2375,50070,5000,20880,9090,9000,8983,8080,8089,8000,7001,6082,5984,4848,3690,3311,3000'
        m_count = 100
        ping = True
